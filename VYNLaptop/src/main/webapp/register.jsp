    ...
    <div class="login-container">
        <form action="register" method="get">
            ...
            <div class="input-div two">
                ...
                <div>
                    <h5>Mật khẩu</h5>
                    <input class="input" type="password" id="password1" aria-describedby="basic-addon1" name="pass1">

                    <div class="icon" style="transform: translate(410px,30px);" ><i class="fas fa-eye icon1" id="icon7"  onclick="myFuction()"></i>
            ...
            <div class="input-div three">
                ...
                <div >
                    ...
                    <input class="input" type="password" id="password2" aria-describedby="basic-addon1" name="pass2">

                    <div style="transform: translate(410px,30px);" class="icon" ><i class="fas fa-eye icon1" id="icon9"  onclick="myFuction2()"></i>
                        <i class="fas fa-eye-slash icon2" id="icon10"  onclick="myFuction2()"></i>
                    </div>


                </div>
            </div>
            <div class="input-div foure">
                <div class="i">
...
<script>
    function myFuction2(){
        ...
        var y = document.getElementById("icon9");
        var z = document.getElementById("icon10");
        if(x.type==='password'){
            y.style.display="block";
            z.style.display="none";
            x.type="text";

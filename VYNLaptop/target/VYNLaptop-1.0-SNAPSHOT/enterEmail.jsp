    ...
    <div class="login-container">
        <form action="TakePassWord">
            ...
            <div class="input-div one">
                ...
                <div >
                    <h5>Email</h5>
                    <input class="input" type="email" name="mail" aria-describedby="basic-addon1" aria-label="Username" required="" value="<%=request.getParameter("mail")==null?"":request.getParameter("mail")%>">


                </div>
            </div>
            <p style="color: red ; font-size: 14px ; font-weight: 600 ; width: 100% ; text-align: center ; margin-bottom: 10px" > <%=request.getAttribute("notify")==null?"" :request.getAttribute("notify")%></p>

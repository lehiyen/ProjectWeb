...
<section class="featured spad">
    ...
    <div class="product__pagination">
        <c:if test="${pageCurrent !=1}">
            <a href="/VYNLaptop/search?id=${pageCurrent-1}"><i class="fa fa-long-arrow-left"></i></a>
        </c:if>
        <c:forEach var="i" begin="${pageStart}" end = "${pageEnd}">

            <a  href="/VYNLaptop/search?id=${i}" class="paginationActive" id="${i}" >${i}</a>
        </c:forEach>
        <c:if test="${pageCurrent!=totalPage}">
            <a href="/VYNLaptop/search?id=${pageCurrent+1}"><i class="fa fa-long-arrow-right"></i></a>
        </c:if>
    </div>
</section>
